...
<<<<<<< Updated upstream
	...
	const renderReviewContent = () => (
		<View style={styles.contentContainer}>
			...
			<View style={styles.optionsContainer}>
				<TouchableOpacity style={styles.option} onPress={triggerShowReviewPrompt}>
					<Text style={styles.optionIcon}>{strings('review_prompt.sentiment_good_face')}</Text>
					<Text style={styles.optionLabel}>{strings('review_prompt.sentiment_good')}</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.option} onPress={triggerShowHelpOptions}>
					<Text style={styles.optionIcon}>{strings('review_prompt.sentiment_bad_face')}</Text>
					<Text style={[styles.optionLabel, styles.optionLabelRed]}>
						{strings('review_prompt.sentiment_bad')}
					</Text>
				</TouchableOpacity>
		...
		() => (
			<View style={styles.contentContainer}>
				...
				{helpOptions.map(({ label, link }, index) => {
					...
					return (
						<TouchableOpacity key={key} onPress={onPress}>
							<Text style={[styles.optionLabel, styles.helpOption]}>{label}</Text>
						</TouchableOpacity>
					);
				})}
			</View>
